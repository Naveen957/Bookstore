...
const Cart = () => {
  ...
  if (!cart || !cart.items) return <div className="p-10 text-center">Loading cart...</div>;
        ...
        {cart.items.length === 0 ? (
          <div className={styles.emptyCard}>
            ...
            <p className={styles.emptyTitle}>
              Discover our collection of premium books and start reading.
            </p>
                  ...
                  <div className={styles.cartItemContent}>
                    ...
                    <div className="flex-1">
                      ...
                      <div className={styles.quantityPriceWrapper}>
                        ...
                        <span className={styles.pricePerItem}>₹{item.price.toFixed(2)} each</span>
                      </div>
                    </div>
                  </div>
                </div>
